...
if len(sys.argv) != 5:
    print('Usage: {0} invertebrates_hits.m6.txt non_invertebrates_hits.m6.txt gene.gff output_dir'.format(sys.argv[0]))
    raise SystemExit
...
contaminate_gene_delete = output_dir + "\\04.scaffold.delete.txt"
contaminate_gene_check = output_dir + "\\04.scaffold.check.txt"
